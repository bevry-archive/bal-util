...
(function() {
  var balUtilFlow, balUtilModules, balUtilPaths, balUtilTypes, isWindows, _ref,
    __slice = [].slice;
  ...
  balUtilModules = {
    ...
    maxNumberOfOpenProcesses: (_ref = process.env.NODE_MAX_OPEN_PROCESSES) != null ? _ref : 30,
    ...
    spawn: function(command, opts, next) {
      balUtilModules.openProcess(function() {
        var err, pid, spawn, stderr, stdout, _ref1;
        spawn = require('child_process').spawn;
        _ref1 = balUtilFlow.extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
        pid = null;
        err = null;
        stdout = '';
        stderr = '';
    ...
    spawnMultiple: function(commands, opts, next) {
      var command, results, tasks, _i, _len, _ref1;
      _ref1 = balUtilFlow.extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
      results = [];
    ...
    initGitRepo: function(opts, next) {
      var branch, commands, gitPath, logger, output, path, remote, url, _ref1;
      _ref1 = balUtilFlow.extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
    ...
    initNodeModules: function(opts, next) {
      var force, logger, nodeModulesPath, packageJsonPath, partTwo, path, pathUtil, _ref1;
      pathUtil = require('path');
      _ref1 = balUtilFlow.extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
